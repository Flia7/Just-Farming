...
import com.flia.gui.FarmingConfigScreen;
import com.flia.pest.PestDetector;
import com.flia.pest.PestEntityDetector;
import com.flia.pest.PestKillerManager;
import com.flia.render.OverlayRenderer;
 ...
 * </ul>
 */
public class Flia implements ClientModInitializer {

    public static final String MOD_ID = "flia";
    ...
    private static final KeyBinding.Category KEY_CATEGORY = KeyBinding.Category.create(Identifier.of("flia", "categories"));
