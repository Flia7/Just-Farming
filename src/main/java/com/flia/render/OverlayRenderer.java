package com.flia.render;

import com.flia.config.FarmingConfig;
import com.flia.pest.GardenPlot;
 ...
 * callback in {@link com.flia.Flia}.
 */
public class OverlayRenderer {
    ...
    private static final RenderLayer PEST_ESP_SEE_THROUGH_LINES = RenderLayer.of(
            ...
            RenderPipeline.builder(RenderPipelines.RENDERTYPE_LINES_SNIPPET)
                    .withLocation("flia/pest_esp_see_through_lines")
    ...
    private static final RenderLayer PEST_TRACER_SEE_THROUGH_LINES = RenderLayer.of(
            ...
            1536,
            RenderPipeline.builder(RenderPipelines.RENDERTYPE_LINES_SNIPPET)
                    .withLocation("flia/pest_tracer_see_through_lines")
                    .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
                    .withDepthWrite(false)
                    .build(),
            RenderLayer.MultiPhaseParameters.builder()
    ...
    private static final RenderLayer REWARP_SEE_THROUGH_LINES = RenderLayer.of(
            ...
            1536,
            RenderPipeline.builder(RenderPipelines.RENDERTYPE_LINES_SNIPPET)
                    .withLocation("flia/rewarp_see_through_lines")
                    .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
                    .withDepthWrite(false)
                    .build(),
            RenderLayer.MultiPhaseParameters.builder()
