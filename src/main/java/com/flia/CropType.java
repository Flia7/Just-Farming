...
public enum CropType {
    ...
    WHEAT              ("crop.flia.wheat",              7,    0.00f,   2.8f, 308),
    CARROT             ("crop.flia.carrot",             7,    0.00f,   2.8f, 308),
    POTATO             ("crop.flia.potato",             7,    0.00f,   2.8f, 308),
    MELON              ("crop.flia.melon",              0,    0.00f, -58.5f, 368),
    PUMPKIN            ("crop.flia.pumpkin",            0,    0.00f, -58.5f, 368),
    SUGAR_CANE         ("crop.flia.sugar_cane",         0, -135.00f,   0.0f, 328),
    CACTUS             ("crop.flia.cactus",             0,    0.00f,   0.0f, 464),
    MUSHROOM           ("crop.flia.mushroom",           0,  -26.57f,   0.0f, 259),
    COCOA_BEANS        ("crop.flia.cocoa_beans",        2,   90.00f, -45.0f, 368),
    NETHER_WART        ("crop.flia.nether_wart",        3,    0.00f,   0.0f, 308),
    POTATO_S_SHAPE     ("crop.flia.potato_s_shape",     7,    0.00f,   2.8f, 308),
    NETHER_WART_S_SHAPE("crop.flia.nether_wart_s_shape",3,    0.00f,   0.0f, 308),
    CARROT_S_SHAPE     ("crop.flia.carrot_s_shape",     7,    0.00f,   2.8f, 308),
    WHEAT_S_SHAPE      ("crop.flia.wheat_s_shape",      7,    0.00f,   2.8f, 308),
    PUMPKIN_S_SHAPE    ("crop.flia.pumpkin_s_shape",    0,    0.00f, -58.5f, 368),
    MELON_S_SHAPE      ("crop.flia.melon_s_shape",      0,    0.00f, -58.5f, 368),
    SUGAR_CANE_S_SHAPE ("crop.flia.sugar_cane_s_shape", 0, -135.00f,   0.0f, 328),
    MOONFLOWER_S_SHAPE ("crop.flia.moonflower_s_shape", 0, -135.00f,   0.0f, 328),
    SUNFLOWER_S_SHAPE  ("crop.flia.sunflower_s_shape",  0, -135.00f,   0.0f, 328),
    WILD_ROSE_S_SHAPE  ("crop.flia.wild_rose_s_shape",  0, -135.00f,   0.0f, 328);
